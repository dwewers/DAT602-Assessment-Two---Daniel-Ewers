...
drop procedure if exists insertData; /*INSERT Statements*/
delimiter //
...
drop procedure if exists updateTbl; /*Update Statements*/
delimiter //
create procedure updateTbl()
begin
...
drop procedure if exists selectTbl; /*SELECT Statements*/
delimiter //
create procedure selectTbl()
begin
...
drop procedure if exists deleteClm; /*Delete Statements*/
delimiter //
create procedure deleteClm()
begin
-- DELETE FROM `tbl_asset` WHERE `assetID`> 5;
